...
java -Xmx32G -Djava.util.concurrent.ForkJoinPool.common.parallelism=$nThreads -cp $repo/PathwayMatcher-1.7.jar no.uib.pap.pathwaymatcher.dsd.cmd.ExportShortestPathMatrix
