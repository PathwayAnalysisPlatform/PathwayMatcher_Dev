...
class MatcherProteoformsStrictTest {
    ...
    void matchInNormalCase() {
        ...
        try {
            entities.add(parser.getProteoform("P01308;00087:53,00798:31,00798:43"));
            entities.add(parser.getProteoform("P01308;00798:95,00798:96,00798:100,00798:109"));
    ...
    void matchWithIsoform() {
        ...
        try {
            entities.add(parser.getProteoform("P02545-2"));
            result = matcher.match(entities);
        ...
        try {
            entities.add(parser.getProteoform("Q9Y6W8-1;00048:180"));
            result = matcher.match(entities);
            assertEquals(4, result.values().size());
        ...
        try {
            entities.add(parser.getProteoform("P00000"));
            result = matcher.match(entities);
            assertEquals(4, result.values().size());
        } catch (ParseException e) {
            fail("Proteoforms should be parsed correctly.");
    ...
    void matchWithIsoformAndPtms() {
        ...
        try {
            entities.add(parser.getProteoform("P02545-1;00046:395"));
        } catch (ParseException e) {
            fail("Proteoforms should be parsed correctly.");
        }
    ...
    void matchWithIsoformAndTwoPtms() {
        ...
        try {
            entities.add(parser.getProteoform("P02545-2;00046:22,00046:395"));
        } catch (ParseException e) {
            fail("Proteoforms should be parsed correctly.");
        }
    ...
    void matchWithWithNullsPtms() {
        ...
        try {
            entities.add(parser.getProteoform("P01892"));
            result = matcher.match(entities);
        ...
        try {
            entities.clear();
            entities.add(parser.getProteoform("P01892;01148:null"));
            result = matcher.match(entities);
            assertEquals(1, result.values().size());
        ...
        try {
            entities.clear();
            entities.add(parser.getProteoform("Q9P218;00039:null,01914:null"));
            result = matcher.match(entities);
            assertEquals(2, result.values().size());
