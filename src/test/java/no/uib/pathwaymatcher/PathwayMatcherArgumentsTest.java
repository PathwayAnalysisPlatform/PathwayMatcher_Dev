...
public class PathwayMatcherArgumentsTest {
    ...
    public void mainWithNoArgumentsTest() throws Exception {
        exit.expectSystemExitWithStatus(NO_ARGUMENTS.getCode());
    ...
    public void cofigurationFileNotFoundTest(){
        ...
        // Invalid
        exit.expectSystemExitWithStatus(COULD_NOT_READ_CONF_FILE.getCode());
    ...
    public void noCofigurationFileTest(){
        ...
        // Valid
        exit.expectSystemExitWithStatus(COULD_NOT_READ_INPUT_FILE.getCode());
