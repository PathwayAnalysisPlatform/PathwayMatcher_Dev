...
write.table(as_data_frame(graphReactome), gzfile("resources/networks/reactome/reactome_main_component.gz"), col.names = T, row.names = F, quote = F)
write.table(as_data_frame(graphBiogrid), gzfile("resources/networks/biogrid/biogrid_main_component.gz"), col.names = T, row.names = F, quote = F)
write.table(as_data_frame(graphMerged), gzfile("resources/networks/merged/merged_main_component.gz"), col.names = T, row.names = F, quote = F)
